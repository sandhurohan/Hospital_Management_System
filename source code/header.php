...
<h5 class="notification-user">Jess 5691258451</h5>
<p class="notification-msg">CI, Laravel PHP Developer</p>
<span class="notification-time">26 minutes ago</span>
</div>
</div>
</li>
...
<li class="header-notification" onclick="window.open('https://www.who.int/philippines/');">
<div class="dropdown-primary dropdown">
